    ...
    <main className="fpAuthPage">
      <section className="fpAuthShell">
        ...
        <header className="fpBrand">
          <div className="fpAcademy">
            THE FLY ACADEMY
          </div>

          <div className="fpBrandRow">
            <div className="fpWordmark">
              FLIGHT PATH
            </div>

            <div className="fpPlane">
              ➤
            </div>
          </div>

          <div className="fpTagline">
            TRACK <span>YOUR</span> GAME. SEE{" "}
        ...
        <section className="fpTrust">
          ...
          <div className="fpTrustItem">
            ...
            <div>
              <strong>
                BUILT FOR FLY FAMILIES
              </strong>

              <span>
                Parents track. Players grow.
              </span>
            </div>
          </div>
        </section>
